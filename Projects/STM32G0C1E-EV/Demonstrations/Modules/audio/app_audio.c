...
/**
  * @brief  TIM6 MSP initialilzation function
  * @param  htim TIM6 handle
  * @retval None
  */
void AppAudio_TIM_MspInit( TIM_HandleTypeDef *htim )
{
    __HAL_RCC_TIM6_CLK_ENABLE();
}

/**
  * @brief  TIM6 MSP deinitialilzation function
  * @param  htim TIM6 handle
  * @retval None
  */
void AppAudio_TIM_MspDeInit( TIM_HandleTypeDef *htim )
{
