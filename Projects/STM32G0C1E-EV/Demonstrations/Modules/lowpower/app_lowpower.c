...
#define LOW_POWER_WAKEUP_FLAG       PWR_FLAG_WUF1
#define LOW_POWER_WAKEKUP_GPIO_PORT PWR_GPIO_A
#define LOW_POWER_WAKEKUP_GPIO_PIN  PWR_GPIO_BIT_0

#define LOW_POWER_WAKEUP_TEXT1      "JOY sel will\nstart\nstandby mode\n"
