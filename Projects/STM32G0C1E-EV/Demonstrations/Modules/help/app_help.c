    ...
    while( user_stop == 0 )
    {
        if( user_action == 1 )
        {
            ...
            if( user_page == 0x01 )
            {
                ...
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP16: VBAT Voltage", LEFT_MODE );
                ...
                line = 11;
                kStorage_OpenFileDrawBMP( 0, LINE( line ), ( uint8_t * )  "STFILES/ICONJP12.bmp" );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP17: VDD Voltage", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "- VDD pin is connected to 3.3V when  ", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "  JP17 is set as shown to the left.  ", LEFT_MODE );
            ...
            else if( user_page == 0x02 )
            {
                ...
                line = 5;
                kStorage_OpenFileDrawBMP( 0, LINE( line ), ( uint8_t * )  "STFILES/ICONJP12.bmp" );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP19: Vin2 Audio OUT", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "- Mono playback is enabled when JP19 ", LEFT_MODE );
                ...
                line = 11;
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP25: Speaker amplifier", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "- Speaker amplifier U17 is enabled", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "  when JP25 is closed.", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "- Speaker amplifier U17 is disabled", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "  when JP25 is open.", LEFT_MODE );
            }
            else if( user_page == 0x03 )
            {
                ...
                line = 5;
                kStorage_OpenFileDrawBMP( 0, LINE( line ), ( uint8_t * )  "STFILES/ICONJP12.bmp" );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP14: RS232/485 Selection", LEFT_MODE );
            ...
            else if( user_page == 0x04 )
            {
                ...
                line = 5;
                kStorage_OpenFileDrawBMP( 0, LINE( line ), ( uint8_t * )  "STFILES/ICONJP12.bmp" );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "JP13/JP15: Rx/Tx Boot", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "- Rx or TX without bootload when ", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "  JP13/JP15 are set as shown to   ", LEFT_MODE );
                BSP_LCD_DisplayStringAt( 64, LINE( line++ ), ( uint8_t * )  "  the left.", LEFT_MODE );
                line++;
                kStorage_OpenFileDrawBMP( 0, LINE( line ), ( uint8_t * )  "STFILES/ICONJP23.bmp" );
