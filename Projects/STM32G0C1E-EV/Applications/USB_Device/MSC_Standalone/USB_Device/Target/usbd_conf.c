...
/**
  ******************************************************************************
  * @file           USB_Device/MSC_Standalone/USB_Device/Target/usbd_conf.c
...
USBD_StatusTypeDef USBD_LL_Init( USBD_HandleTypeDef *pdev )
{
    ...
    HAL_PCDEx_PMAConfig( ( PCD_HandleTypeDef * )pdev->pData, MSC_EPIN_ADDR, PCD_SNG_BUF, 0x90 );
    HAL_PCDEx_PMAConfig( ( PCD_HandleTypeDef * )pdev->pData, MSC_EPOUT_ADDR, PCD_SNG_BUF, 0xD0 );
