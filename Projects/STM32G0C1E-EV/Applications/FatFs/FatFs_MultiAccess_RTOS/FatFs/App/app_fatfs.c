...
/**
  ...
  * @brief   FatFs_MultiAccess_RTOS application file
  ******************************************************************************
  * @attention
  *
...
int32_t MX_FATFS_Process( void )
{
    ...
    /* FatFs Application State Machine */
    switch( Appli_state )
    {
...
/**
  * @brief EXTI line detection falling callbacks
...
/**
  * @brief EXTI line detection rising callbacks
  * @param GPIO_Pin: Specifies the pins connected EXTI line
  * @retval None
  */
